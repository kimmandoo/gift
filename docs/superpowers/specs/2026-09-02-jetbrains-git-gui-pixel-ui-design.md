...
gift is a clean-room, black-box behavioral reverse engineering project for
...
- Use neutral gift names and original code/assets even when the behavior is
...
the right column are gift's implementation concepts, not copied UI labels.

| JetBrains-observed concept | gift behavior target | Evidence required |
| --- | --- | --- |
